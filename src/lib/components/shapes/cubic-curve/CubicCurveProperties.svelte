...
<table>
    <tbody>
        ...
        <tr>
            <td>control point 1 x</td>
            <td class="value">
                <input type="number" bind:value={points[2]}/>
            </td>
        </tr>
        <tr>
            <td>control point 1 y</td>
            <td class="value">
                <input type="number" bind:value={points[3]}/>
            </td>
        </tr>
        <tr>
            <td>control point 2 x</td>
            <td class="value">
                <input type="number" bind:value={points[4]}/>
            </td>
        </tr>
        <tr>
            <td>control point 2 y</td>
            <td class="value">
                <input type="number" bind:value={points[5]}/>
            </td>
        </tr>
        <tr>
            <td>end point x</td>
            <td class="value">
                <input type="number" bind:value={points[6]}/>
            </td>
        </tr>
        <tr>
            <td>end point y</td>
            <td class="value">
                <input type="number" bind:value={points[7]}/>
            </td>
        </tr>
    </tbody>
</table> 